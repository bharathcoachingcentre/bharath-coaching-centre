...
export default function CbseClass8Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/cbse_8_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/cbse_8_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/cbse_8_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/cbse_8_unit_questions.pdf" },
