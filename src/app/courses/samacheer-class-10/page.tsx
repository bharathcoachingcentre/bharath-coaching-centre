...
export default function SamacheerClass10Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "Samacheer Book", pdf: "/pdfs/samacheer_10_ncert.pdf" },
        { name: "Book Back Solutions", pdf: "/pdfs/samacheer_10_solutions.pdf" },
        { name: "Chapter-wise Test Question Papers", pdf: "/pdfs/samacheer_10_unit_questions.pdf" },
        { name: "Model Board Question Papers", pdf: "/pdfs/samacheer_10_model_paper.pdf" },
        { name: "Previous Year Board Question Papers", pdf: "/pdfs/samacheer_10_previous_questions.pdf" },
      ];
