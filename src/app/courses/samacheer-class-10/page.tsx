...
export default function SamacheerClass10Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/samacheer_10_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/samacheer_10_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/samacheer_10_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/samacheer_10_unit_questions.pdf" },
        { name: "Model Board question paper", pdf: "/pdfs/samacheer_10_model_paper.pdf" },
      ];
