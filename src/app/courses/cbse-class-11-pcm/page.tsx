...
export default function CbseClass11PcmPage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Book PDF", pdf: "/pdfs/cbse_11_pcm_ncert.pdf" },
        { name: "NCERT Book Back Solution", pdf: "/pdfs/cbse_11_pcm_solutions.pdf" },
        { name: "NCERT Chapterwise Test Question Paper", pdf: "/pdfs/cbse_11_pcm_unit_questions.pdf" },
        { name: "Model Board Question Paper", pdf: "/pdfs/cbse_11_pcm_model_paper.pdf" },
        { name: "Previous Year Board Question Paper", pdf: "/pdfs/cbse_11_pcm_model_paper.pdf" },
      ];
