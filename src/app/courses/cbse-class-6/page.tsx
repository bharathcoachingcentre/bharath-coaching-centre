...
export default function CbseClass6Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/cbse_6_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/cbse_6_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/cbse_6_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/cbse_6_unit_questions.pdf" },
