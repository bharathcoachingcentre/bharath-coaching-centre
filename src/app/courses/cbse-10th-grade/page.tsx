...
export default function Cbse10thGradePage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Book PDF", pdf: "/pdfs/cbse_10_ncert.pdf" },
        { name: "NCERT Book Back Solution", pdf: "/pdfs/cbse_10_solutions.pdf" },
        { name: "NCERT Chapterwise Test Question Paper", pdf: "/pdfs/cbse_10_unit_questions.pdf" },
        { name: "Model Board Question Paper", pdf: "/pdfs/cbse_10_model_paper.pdf" },
        { name: "Previous Year Board Question Paper", pdf: "/pdfs/cbse_10_model_paper.pdf" },
      ];
