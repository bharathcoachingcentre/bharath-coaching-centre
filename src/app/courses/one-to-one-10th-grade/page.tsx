...
export default function OneToOne10thGradePage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/cbse_10_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/cbse_10_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/cbse_10_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/cbse_10_unit_questions.pdf" },
        { name: "Model Board question paper", pdf: "/pdfs/cbse_10_model_paper.pdf" },
      ];
    ...
    <div>
      <section className="relative h-64 md:h-80 w-full flex items-center justify-center">
        <Image
          ...
          alt="One to One 10th Grade Banner"
          fill
