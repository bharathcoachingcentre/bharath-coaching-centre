...
export default function SamacheerClass11PcmPage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "Samacheer Book", pdf: "/pdfs/samacheer_11_pcm_ncert.pdf" },
        { name: "Book Back Solutions", pdf: "/pdfs/samacheer_11_pcm_solutions.pdf" },
        { name: "Chapter-wise Test Question Papers", pdf: "/pdfs/samacheer_11_pcm_unit_questions.pdf" },
        { name: "Model Board Question Papers", pdf: "/pdfs/samacheer_11_pcm_model_paper.pdf" },
        { name: "Previous Year Board Question Papers", pdf: "/pdfs/samacheer_11_pcm_previous_questions.pdf" },
      ];
