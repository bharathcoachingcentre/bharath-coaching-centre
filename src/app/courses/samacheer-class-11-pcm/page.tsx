...
export default function SamacheerClass11PcmPage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/samacheer_11_pcm_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/samacheer_11_pcm_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/samacheer_11_pcm_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/samacheer_11_pcm_unit_questions.pdf" },
        { name: "Model Board question paper", pdf: "/pdfs/samacheer_11_pcm_model_paper.pdf" },
      ];
