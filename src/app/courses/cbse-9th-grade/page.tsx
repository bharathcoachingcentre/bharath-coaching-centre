...
export default function Cbse9thGradePage() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        ...
        },
        {
          ...
          icon: Layers,
          pdf: "/pdfs/cbse_9_unit_questions.pdf",
        ...
        },
        {
          ...
          icon: GraduationCap,
          pdf: "/pdfs/cbse_9_model_paper.pdf",
