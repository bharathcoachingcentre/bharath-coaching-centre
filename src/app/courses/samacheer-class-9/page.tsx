      ...
      const studyMaterials = [
        {
          ...
          icon: BookOpen,
          pdf: "/pdfs/samacheer_9_ncert.pdf",
        ...
        },
        {
          ...
          icon: FileCheck,
          pdf: "/pdfs/samacheer_9_solutions.pdf",
        ...
        },
        {
          ...
          icon: Layers,
          pdf: "/pdfs/samacheer_9_unit_questions.pdf",
        ...
        },
        {
          ...
          icon: GraduationCap,
          pdf: "/pdfs/samacheer_9_model_paper.pdf",
        ...
        },
        {
          ...
          icon: FileText,
          pdf: "/pdfs/samacheer_9_previous_questions.pdf",
            ...
            <div className="space-y-12">
                <div className="space-y-6">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed max-w-xl font-medium text-left">
                        Our meticulously planned schedule ensures comprehensive coverage of the entire Samacheer 9th Grade syllabus with dedicated time for revision and doubt clearing sessions.
                    </p>
                </div>
      ...
      <section className="py-16 md:py-24" style={{ backgroundColor: 'rgb(21 49 61)' }} ref={studyMaterialSectionRef}>
        <div className="container mx-auto text-center px-4">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-12">
            Access our comprehensive collection of Samacheer 9th Grade study materials to boost your preparation
          </p>
