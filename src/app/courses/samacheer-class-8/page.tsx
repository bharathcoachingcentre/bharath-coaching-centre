...
export default function SamacheerClass8Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "Samacheer Book", pdf: "/pdfs/samacheer_8_ncert.pdf" },
        { name: "Book Back Solutions", pdf: "/pdfs/samacheer_8_solutions.pdf" },
        { name: "Chapter-wise Test Question Papers", pdf: "/pdfs/samacheer_8_unit_questions.pdf" },
        { name: "Model Board Question Papers", pdf: "/pdfs/samacheer_8_model_paper.pdf" },
        { name: "Previous Year Board Question Papers", pdf: "/pdfs/samacheer_8_previous_questions.pdf" },
      ];
