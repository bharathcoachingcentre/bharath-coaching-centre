...
export default function SamacheerClass8Page() {
    ...
    const benefits = [
      ...
      const studyMaterials = [
        { name: "NCERT Books", pdf: "/pdfs/samacheer_8_ncert.pdf" },
        { name: "NCERT Solutions", pdf: "/pdfs/samacheer_8_solutions.pdf" },
        { name: "Formula Booklet", pdf: "/pdfs/samacheer_8_formula.pdf" },
        { name: "Unit wise question papers", pdf: "/pdfs/samacheer_8_unit_questions.pdf" },
        { name: "Model Board question paper", pdf: "/pdfs/samacheer_8_model_paper.pdf" },
      ];
