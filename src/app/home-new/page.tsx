        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Button asChild variant="outline" className="relative mt-8 rounded-full px-8 py-6 text-lg border-2 hover-swipe-right" style={{borderColor: '#2abfaf', backgroundColor: '#fff', color: '#2abfaf', height: '54px'}}>
