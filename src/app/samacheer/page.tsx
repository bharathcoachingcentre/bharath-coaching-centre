...
const classes = [
  { name: "Class 6", number: 6, href: "/courses/samacheer-class-6" },
  { name: "Class 7", number: 7, href: "/courses/samacheer-class-7" },
  { name: "Class 8", number: 8, href: "/courses/samacheer-class-8" },
  { name: "Class 9", number: 9, href: "/courses/samacheer-class-9" },
  { name: "Class 10", number: 10, href: "/courses/samacheer-class-10" },
  { name: "Class 11", number: 11, href: "/courses/samacheer-class-11-pcm" },
  { name: "Class 12", number: 12, href: "/courses/samacheer-class-12-pcm" },
];

const studyMaterials = [
    { name: "Samacheer Book", icon: BookOpen },
    { name: "Book Back Solutions", icon: FileCheck },
    { name: "Chapter-wise Test QP", icon: FileText },
...
export default function SamacheerPage() {
    const boardMaterials = {
        Samacheer: {
          "Samacheer Book": [
            { class: "Class 12", pdf: "/pdfs/samacheer_12_pcm_ncert.pdf" },
            { class: "Class 11", pdf: "/pdfs/samacheer_11_pcm_ncert.pdf" },
          ...
          "Book Back Solutions": [
            { class: "Class 12", pdf: "/pdfs/samacheer_12_pcm_solutions.pdf" },
            { class: "Class 11", pdf: "/pdfs/samacheer_11_pcm_solutions.pdf" },
          ...
          "Chapter-wise Test QP": [
            { class: "Class 12", pdf: "/pdfs/samacheer_12_pcm_unit_questions.pdf" },
            { class: "Class 11", pdf: "/pdfs/samacheer_11_pcm_unit_questions.pdf" },
  ...
  return (
    <div>
        <section className="relative w-full flex items-center justify-center text-center text-white overflow-hidden pt-24 bg-gradient-to-r from-blue-600 to-teal-500" style={{ height: '500px' }}>
        ...
        <div className="w-full py-16 md:py-24 px-4 bg-gradient-to-br from-blue-50/50 to-teal-50/50">
            <div className="container mx-auto text-center">
                ...
                Access comprehensive study materials, book back solutions, and practice papers for classes 6 to 12.
                </p>
                ...
                {classes.map((item, index) => (
                    <div key={index} className="group [perspective:1000px] mx-auto" style={{ minHeight: '350px', width: '100%', maxWidth: '310px' }}>
                        <div className="relative h-full w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                            ...
                            {/* Back side */}
                            <Card className="absolute h-full w-full [backface-visibility:hidden] [transform:rotateY(180deg)] rounded-[2.5rem] shadow-2xl p-6 flex flex-col justify-center border-none bg-gradient-to-br from-blue-600 to-teal-500">
                                ...
                                <CardContent className="p-2 flex flex-col gap-2.5">
                                    {studyMaterials.map((material) => {
                                        const materialKeyMap: { [key: string]: string } = {
                                            "Samacheer Book": "Samacheer Book",
                                            "Book Back Solutions": "Book Back Solutions",
                                            "Chapter-wise Test QP": "Chapter-wise Test QP",
                                        ...
                                        const materialLinks = (boardMaterials.Samacheer as any)[boardMaterialKey] || [];
