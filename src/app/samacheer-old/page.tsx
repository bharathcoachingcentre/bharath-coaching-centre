...
export default function SamacheerOldPage() {
    ...
    const benefits = [
      ...
      const boardMaterials = {
        ...
        Samacheer: {
            "Book Back Solution": [
                { class: "Class 12 PCM", pdf: "/pdfs/samacheer_12_pcm_book_back.pdf" },
                { class: "Class 11 PCM", pdf: "/pdfs/samacheer_11_pcm_book_back.pdf" },
            ...
            "Chapter-wise Test Question paper": [
                { class: "Class 12 PCM", pdf: "/pdfs/samacheer_12_pcm_chapter_wise.pdf" },
                { class: "Class 11 PCM", pdf: "/pdfs/samacheer_11_pcm_chapter_wise.pdf" },
