          ...
          <Card className="border-none shadow-xl rounded-[32px] overflow-hidden bg-white">
            <CardHeader className="p-10 pb-0">
              <div className="flex items-center gap-4">
                ...
                <CardTitle className="text-2xl font-black text-gray-900 tracking-tight">New Performer Details</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-10 pt-8 space-y-8">
                ...
                <div className="md:col-span-2 space-y-4">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <div className="space-y-1">
                      ...
                      {form.watch("imageUrl") && (
                        <Button type="button" variant="ghost" size="sm" onClick={() => form.setValue("imageUrl", "")} className="text-red-500 hover:text-red-600 hover:bg-red-50 p-0 h-auto font-bold mt-2">
              ...
              <div className="flex items-center justify-end gap-4 pt-10 border-t border-gray-50 mt-10">
                <Button type="button" variant="ghost" onClick={() => router.push("/admin/top-performers")} disabled={isSubmitting}>
                  Cancel
                </Button>
