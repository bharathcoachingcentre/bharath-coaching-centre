    ...
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <div className="text-center py-32 bg-white rounded-[32px] shadow-sm border border-dashed border-gray-200">
          ...
          <p className="text-gray-500 mt-2 max-w-xs mx-auto">Create teacher accounts to start managing your academy faculty.</p>
          <Button asChild variant="outline" className="mt-8 rounded-xl font-bold">
            <Link href="/admin/users/create">Add Staff Account</Link>
          </Button>
        </div>
      ) : (
