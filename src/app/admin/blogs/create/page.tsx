...
export default function CreateBlogPage() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        form.setValue("featuredImage", reader.result as string, { shouldValidate: true });
      };
      ...
      <Card className="border-none shadow-xl rounded-[32px] overflow-hidden bg-white">
        <CardHeader className="p-8 md:p-12 pb-0">
          <div className="flex items-center gap-5">
            ...
            <div>
              <CardTitle className="text-3xl font-black text-gray-900 tracking-tight">New Article</CardTitle>
              <p className="text-gray-400 font-medium text-sm mt-1">Compose your latest insight or news update</p>
            </div>
          </div>
        </CardHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                ...
                />
                {form.formState.errors.slug && <p className="text-xs text-red-500 font-bold">{form.formState.errors.slug.message}</p>}
              </div>
              ...
              <div className="md:col-span-2 space-y-3">
                ...
                <Textarea 
                  ...
                  placeholder="Summarize the article for the list view..."
                  className="min-h-[100px] bg-gray-50 border-none rounded-xl p-6 font-medium text-gray-600 resize-none"
                />
                {form.formState.errors.excerpt && <p className="text-xs text-red-500 font-bold">{form.formState.errors.excerpt.message}</p>}
              </div>
              ...
              <div className="space-y-3">
                ...
                <Select onValueChange={(v) => form.setValue("status", v)} defaultValue="draft">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                  ...
                  <p className="text-[10px] text-gray-400 italic">Recommended: 1200x600px. High quality landscape orientation.</p>
                </div>
              ...
              {form.formState.errors.featuredImage && <p className="text-xs text-red-500 font-bold">{form.formState.errors.featuredImage.message}</p>}
            </div>
            ...
            <div className="space-y-4">
              ...
              />
              {form.formState.errors.content && <p className="text-xs text-red-500 font-bold">{form.formState.errors.content.message}</p>}
            </div>
