...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "[.font-home2-header_&]:focus:text-[#1497d4] [.font-home2-header_&]:data-[state=open]:text-[#1497d4] [.font-home2-header_&]:focus:shadow-[inset_4px_0_0_0_#1497d4] [.font-home2-header_&]:data-[state=open]:shadow-[inset_4px_0_0_0_#1497d4]",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "[.font-home2-header_&]:focus:text-[#1497d4] [.font-home2-header_&]:focus:shadow-[inset_4px_0_0_0_#1497d4]",
      inset && "pl-8",
      className
    )}
    {...props}
