      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56 rounded-xl shadow-xl border-gray-100 p-2">
                <DropdownMenuItem asChild>
                  <Link href="/courses" className="p-3 cursor-pointer hover:bg-blue-50 rounded-lg block">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button variant="ghost" asChild className="text-gray-700 font-semibold hover:text-blue-600 hover:bg-blue-50 border-2 border-transparent hover:border-blue-100 rounded-lg px-6">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="rounded-l-3xl">
                ...
                <div className="flex flex-col space-y-6 mt-10">
                  <Link href="/courses" className="text-xl font-bold text-gray-900 border-b pb-4 border-gray-100">Courses</Link>
                  {navLinks.map((link) => (
